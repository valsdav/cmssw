...
#ifndef RecoParticleFlow_PFClusterProducer_BarrelLayerTiles_h
#define RecoParticleFlow_PFClusterProducer_BarrelLayerTiles_h
...
using EBLayerTiles = BarrelLayerTilesT<EBTilesConstants, PhiWrapper>;
using HBLayerTiles = BarrelLayerTilesT<HBTilesConstants, PhiWrapper>;
using HOLayerTiles = BarrelLayerTilesT<HOTilesConstants, PhiWrapper>;
#endif
