#ifndef PHYSICS_TOOLS__PYTORCH_ALPAKA__INTERFACE__ALPAKA_CONFIG_H_
#define PHYSICS_TOOLS__PYTORCH_ALPAKA__INTERFACE__ALPAKA_CONFIG_H_
...
#endif  // PHYSICS_TOOLS__PYTORCH_ALPAKA__INTERFACE__ALPAKA_CONFIG_H_
