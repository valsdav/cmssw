...
class testTorchFromBufferModelEvalMTMS : public testBasePyTorch {
  CPPUNIT_TEST_SUITE(testTorchFromBufferModelEvalMTMS);
  CPPUNIT_TEST(test);
...
CPPUNIT_TEST_SUITE_REGISTRATION(testTorchFromBufferModelEvalMTMS);

std::string testTorchFromBufferModelEvalMTMS::pyScript() const { return "create_dnn_sum.py"; }
/*
...
void testTorchFromBufferModelEvalMTMS::test() {
